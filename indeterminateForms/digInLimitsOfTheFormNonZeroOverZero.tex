...
\begin{example}
  ...
  \begin{explanation}
   ...
   \end{explanation}
\end{example}
Again, to determine if the numerator will be positive or negative for all $x$ sufficiently close to, but greater than, $3$, we cannot plug in a single value of $x$. (Even plugging in $x=3.0000001$ would not be enough to justify our result.) We have to verify the sign for ALL values of $x$ that are sufficiently close to, but greater than $3$.
